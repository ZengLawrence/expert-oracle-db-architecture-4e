...
-- This script relies on BIG_TABLE (see big_table.sql script in ch00 folder)
...
-- should throw an error, not enough space
alter table big_table1 move;
-- should throw an error, have to move each partition
